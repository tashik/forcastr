...
namespace Forcastr
{
	...
	struct DataPoint:SLList
	{
		...
		//Ордината
		float fY;
		//Являются ли данные оригинальными
		char bIsOriginal;
